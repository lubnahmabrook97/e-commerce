...
<body style="back">
 ...
 <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from products order by product_id DESC");
 ...
 <td><center>
   ...
   <a href="Edit_Product.php?P_ID=<?php echo $P_ID; ?>" class="btn btn-primary btn-sm" role="button">Edit</a><br>
 
 
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Product ?')==true)
{window.location='Delete_Product.php?P_ID=<?php echo $P_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a></center></td>                     
