...
$sql1 = mysqli_query($dbConn,"select * from categories where category_id='$C_ID'");
...
$update = mysqli_query($dbConn,"update categories set category_name='$Category_Name' where category_id='$C_ID'");
        ...
        <div class="navbar-header">
          ...
          <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        <li class="active">
                            <strong>Categories Information</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <input type="hidden" name="C_ID" value="<?php echo $C_ID; ?>"/>
                                  ...
                                  <div class="form-group"><label class="col-sm-2 control-label">Category Name</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" value="<?php echo $Category_Name; ?>" type="text" name="Category_Name" class="form-control" required></div>
                                </div>
