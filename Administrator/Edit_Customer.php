...
$row1 = mysqli_fetch_array($sql1);
	...
	$Name = $row1['customer_name'];
						$Phone_Number = $row1['customer_phone'];
...
$update = mysqli_query($dbConn,"update customers set customer_name='$Name', customer_phone='$Phone_Number', customer_email='$Email_Address', customer_password='$Password', customer_status='$Status' where customer_id='$C_ID'");
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Customer.php?C_ID=<?php echo $C_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
                    <input type="hidden" name="C_ID" value="<?php echo $C_ID; ?>"/>
                                ...
                                <div class="hr-line-dashed"></div>
                                  ...
                                  <div class="form-group"><label class="col-sm-2 control-label">Phone Number</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" value="<?php echo $Phone_Number; ?>" type="text" name="Phone_Number" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>                                
                                  ...
                                  <div class="form-group"><label class="col-sm-2 control-label">Email Address</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" value="<?php echo $Email_Address; ?>" type="email" name="Email_Address" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>  
                                  ...
                                  <div class="form-group"><label class="col-sm-2 control-label">Password</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" value="<?php echo $Password; ?>" type="password" name="Password" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>  
