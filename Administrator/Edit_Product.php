...
$sql1 = mysqli_query($dbConn,"select * from products where product_id='$P_ID'");
...
$update = mysqli_query($dbConn,"update products set product_name='$Name', product_description='$Description', product_price='$Price', product_color='$Color', product_quantity='$Quantity' where product_id='$P_ID'");
...
<head>
    ...
    <title>:: Foodie | Administration Login ::</title>
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                     ...
                     <form method="post" action="Edit_Product.php?P_ID=<?php echo $P_ID; ?>" class="form-horizontal" enctype="multipart/form-data">
                    <input type="hidden" name="P_ID" value="<?php echo $P_ID; ?>"/>
                                  ...
                                  <div class="form-group"><label class="col-sm-2 control-label">Name</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" value="<?php echo $Name; ?>" type="text" name="Name" class="form-control" required></div>
                                </div>
                              ...
                              <div class="form-group"><label class="col-sm-2 control-label">Description</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" value="<?php echo $Description; ?>" type="text" name="Description" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                              ...
                              <div class="form-group"><label class="col-sm-2 control-label">Price</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" value="<?php echo $Price; ?>" type="number" min="1" name="Price" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                              ...
                              <div class="form-group"><label class="col-sm-2 control-label">Quantity</label>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" value="<?php echo $Quantity; ?>" type="number" min="1" name="Quantity" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                    ...
                                    <div class="col-sm-10"><input style="width:450px" value="<?php echo $Color; ?>" type="text" name="Color" class="form-control" required></div>
                                </div>
                                <div class="hr-line-dashed"></div>
