...
<body style="back">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Customers List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from customers order by customer_id DESC");
					while ($row1 = mysqli_fetch_array($sql1)){
						...
						$Add_Date_Time = $row1['customer_data_time'];
 ...
 <td><center>
    ...
    <a href="Edit_Customer.php?C_ID=<?php echo $C_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a><br>

 
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Customer ?')==true)
{window.location='Delete_Customer.php?C_ID=<?php echo $C_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a></center></td>                     
