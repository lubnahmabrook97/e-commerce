            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Categories List Information</h5>
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from categories order by category_id DESC");
...
{window.location='Delete_Category.php?C_ID=<?php echo $C_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a>


<br>  <a href="Edit_Category.php?C_ID=<?php echo $C_ID; ?>" style="width:52px" class="btn btn-primary btn-sm" role="button">Edit</a></center></td>                     
