...
<body style="back">
 ...
 <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                    <?php
					$sql1 = mysqli_query($dbConn,"select * from orders order by order_date_time DESC");
					while ($row1 = mysqli_fetch_array($sql1)){
						...
						$order_date_time = $row1['order_date_time'];
					
						
						
					$sql2 = mysqli_query($dbConn,"select * from customers where customer_id='$customer_id'");
					$row2 = mysqli_fetch_array($sql2);	
					$C_Name = $row2['customer_name'];
					$C_Phone_Number = $row2['customer_phone'];
                    ...
                    <tr class="grade">
                        ...
                        <td><a href='View_Order_Products.php?O_ID=<?php echo $O_ID; ?>' class="btn btn-priamry">View Order Products</a></td>
 ...
 <a href="JavaScript:if(confirm('Are You Sure To Update This Order Status ?')==true)
{window.location='Accept_Order.php?O_ID=<?php echo $O_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Accept</a>
...
<br>
 ...
 <a href="JavaScript:if(confirm('Are You Sure To Delete This Order ?')==true)
{window.location='Delete_Order.php?O_ID=<?php echo $O_ID; ?>';}" class="btn btn-primary btn-sm" role="button">Delete</a></center></td>                     
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                     ...
                     {extend: 'pdf', title: 'Orders Report'},
