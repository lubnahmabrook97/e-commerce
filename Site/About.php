			...
			<div class="row">
				<div class="col-md-4 p-b-30">
					<div class="hov-img-zoom">
						<img src="images/master-slide-02.jpg" alt="IMG-ABOUT">
					</div>
				</div>
				...
				<div class="col-md-8 p-b-30">
					...
					<p class="p-b-28">
A group of girls we decided to invest by using e-commerce and its applications with beauty products by providing global products of high quality and diversity. We bring you the latest products in the world of cosmetics to your homes.
